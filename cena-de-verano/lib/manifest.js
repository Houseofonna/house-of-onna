(function () {
  ...
  window.__BRAND__ = {
    name: "House of ŌNNA",
    event: {
      title: "La Cena de Verano",
      date: "24 de julio, 2026",
      dateISO: "2026-07-24",
      location: "Mallorca — viñedo por confirmar",
      locationStatus: "pending", // "pending" | "confirmed"
      priceStatus: "pending",
      timeStatus: "pending"
    },
    whatsapp: {
      // TODO Cristina: sustituir por el número real en formato internacional sin "+" ni espacios, p.ej. 34612345678
      number: "34000000000",
      message: "Quiero reservar mi plaza para La Cena de Verano"
    },
    videos: {
      hero: { youtubeId: "h_8g9GaUfWM", label: "La Cena de Verano — House of ŌNNA" },
      replay: { youtubeId: "sl8gZPXflR8", label: "La Cena de Inicio — House of ŌNNA" },
    ...
    gallery: [
      ...
      { src: "assets/img/galeria-02.webp", alt: "Invitada en la mesa durante la Cena de Inicio" },
